...
/qemu-mips-static -hackbind -hackproc -hacksysinfo -execve "/qemu-mips-static -hackbind -hackproc -hacksysinfo " -E LD_PRELOAD="libnvram-faker.so" /bin/sh /run_background.sh
/fuzz_bins/utils/sleep 1
/run_setup.sh
/fuzz_bins/utils/sleep 1
...
export AFL_AUTH_CMD="sleep 3; /fuzz_bins/ghup_bins/Initializer.static -t 127.0.0.1 -p 80 -b trendnet -m SINGLE_LOGIN"
