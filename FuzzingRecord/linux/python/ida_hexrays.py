...
class Hexrays_Hooks(object):
    ...
    def collect_warnings(self, warnings: "qstrvec_t *", cfunc: "cfunc_t") -> "int":
        r"""
        collect_warnings(self, warnings, cfunc) -> int
        ...
        @param cfunc: (cfunc_t *)
        """
        return _ida_hexrays.Hexrays_Hooks_collect_warnings(self, warnings, cfunc)
...
class stkvar_ref_t(object):
    ...
    def get_stkvar(self, udm: "udm_t"=None, p_off: "uval_t *"=None) -> "ssize_t":
        r"""
        get_stkvar(self, udm=None, p_off=None) -> ssize_t
        ...
        """
        return _ida_hexrays.stkvar_ref_t_get_stkvar(self, udm, p_off)
...
class mop_t(object):
    ...
    def make_insn(self, ins: "minsn_t") -> "void":
        ...
        @param ins: (C++: minsn_t *)
        """
        return _ida_hexrays.mop_t_make_insn(self, ins)
    ...
    def get_stkvar(self, udm: "udm_t"=None, p_off: "uval_t *"=None) -> "ssize_t":
        ...
        @return: index of stkvar in the frame or -1
        """
        return _ida_hexrays.mop_t_get_stkvar(self, udm, p_off)

    def get_stkoff(self, p_off: "sval_t *") -> "bool":
        r"""
        ...
        @return: success
        """
        return _ida_hexrays.mop_t_get_stkoff(self, p_off)
