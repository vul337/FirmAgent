...
def set_process_options(path: "char const *", args: "char const *", sdir: "char const *", host: "char const *", _pass: "char const *", port: "int") -> "void":
    r"""
    ...
    @param port: (C++: int)
    """
    return _ida_dbg.set_process_options(path, args, sdir, host, _pass, port)
